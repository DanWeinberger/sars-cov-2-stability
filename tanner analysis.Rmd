...
```{r}
a1.m <- melt (a1, id.vars=c('temp','time', 'humidity','surface','replicate','variant','date')) %>%
...
t_half_alum <- (3.47 - log10((10^3.47)/2 ))/0.016231

t_half_ss <- (3.31 - log10((10^3.31)/2 ))/(0.016231- 0.001577)

t_half_plastic <- (3.70 - log10((10^3.70)/2 ))/(0.016231- 0.004454)
...
t_half_30 <- (3.71 - log10((10^3.71)/2 ))/0.0177979

t_half_60 <- ((3.71+0.46) - log10((10^(3.71+0.46))/2 ))/(0.0177979+0.0984324)
