...
t_half_30 <- (pred.coefs.reg.mean[,'humidity0.3'] - log10((10^pred.coefs.reg.mean[,'humidity0.3'])/2 ))/(-1*pred.coefs.reg.mean[,'time'] )   

t_half_60 <- (pred.coefs.reg.mean[,'humidity0.6'] - log10((10^pred.coefs.reg.mean[,'humidity0.6'])/2 ))/(-1*(pred.coefs.reg.mean[,'time']+
                                                                                                             pred.coefs.reg.mean[,'time:humidity0.6'] ) )   
